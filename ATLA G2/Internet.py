...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Google", self)
        about_action.setStatusTip("Find out more about Google")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')), "Google kotisivu", self)
        navigate_mozarella_action.setStatusTip("Go to Google Homepage")
